...
async function transformMain(code, filename, options, pluginContext, ssr, asCustomElement) {
  ...
  if (((_b = descriptor.script) == null ? void 0 : _b.lang) === "ts" || ((_c = descriptor.scriptSetup) == null ? void 0 : _c.lang) === "ts") {
    const { code: code2, map: map2 } = await (0, import_vite.transformWithEsbuild)(resolvedCode, filename, { loader: "ts" }, resolvedMap);
    resolvedCode = code2;
